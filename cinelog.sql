...
('O Poderoso Chefão', 'Francis Ford Coppola', 1972, 'Drama/Crime', 9.8, 'O patriarca de uma dinastia do crime organizado transfere o controle de seu império para seu relutante filho.', 'https://image.tmdb.org/t/p/w500/3bhkrj58Vtu7enYsLegHnDmni69.jpg', 1),
('Her', 'Spike Jonze', 2013, 'Drama/Romance', 8.7, 'Um escritor solitário desenvolve uma relação improvável com um sistema operacional projetado para satisfazer cada uma de suas necessidades.', 'https://image.tmdb.org/t/p/w500/yk4J7b4MqWZmSMXcnGHJsVE59vq.jpg', 1),
